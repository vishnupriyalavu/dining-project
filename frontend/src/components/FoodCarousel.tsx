...
export default function FoodCarousel() {
  ...
  return (
    <section className="relative overflow-hidden rounded-[36px] shadow-2xl shadow-orange-200/40">
            ...
            <div key={slide.title} className="relative min-w-full">
              ...
              <div className="absolute inset-0 flex items-end p-6 sm:p-8 lg:p-10">
                <div className="max-w-lg text-white">
                  <p className="inline-flex items-center gap-2 rounded-full bg-white/15 px-4 py-2 text-xs font-semibold uppercase tracking-[0.28em] text-orange-200 backdrop-blur">
