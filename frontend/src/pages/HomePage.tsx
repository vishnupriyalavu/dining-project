...
export default function HomePage() {
  ...
  return (
    <div className="bg-[radial-gradient(circle_at_top_left,_rgba(112,25,61,0.14),_transparent_28%),radial-gradient(circle_at_top_right,_rgba(154,77,108,0.12),_transparent_22%),linear-gradient(180deg,_#fdf9fb_0%,_#ffffff_40%,_#fbf3f7_100%)]">
      ...
      <section className="mx-auto grid max-w-7xl gap-8 px-4 py-8 sm:px-6 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:px-8 lg:py-12">
        <div className="flex flex-col justify-center">
          <p className="inline-flex w-fit rounded-full border border-[#70193d]/10 bg-white/80 px-4 py-2 text-sm font-semibold text-[#70193d] shadow-sm backdrop-blur">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              href="#menu"
              className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[#4a0d29] via-[#70193d] to-[#9a4d6c] px-6 py-3 font-bold text-white shadow-lg shadow-[#70193d]/20 transition-all duration-300 hover:scale-105 hover:from-[#5b1031] hover:via-[#7f1d46] hover:to-[#ad5f7d]"
            >
              Explore Menu
            ...
            <a
              href="#featured"
              className="inline-flex items-center rounded-full border border-[#70193d]/10 bg-white px-6 py-3 font-semibold text-slate-700 shadow-sm transition hover:bg-[#f8eff3]"
            >
              Featured Dishes
            </a>
          </div>
          ...
          <div className="mt-10 grid gap-3 sm:grid-cols-3">
            <div className="rounded-[26px] border border-[#70193d]/10 bg-white/90 p-4 shadow-[0_18px_45px_rgba(112,25,61,0.08)] backdrop-blur">
              <Clock3 className="h-5 w-5 text-[#70193d]" />
            ...
            <div className="rounded-[26px] border border-[#70193d]/10 bg-white/90 p-4 shadow-[0_18px_45px_rgba(112,25,61,0.08)] backdrop-blur">
              <Star className="h-5 w-5 text-[#70193d]" />
            ...
            <div className="rounded-[26px] border border-[#70193d]/10 bg-white/90 p-4 shadow-[0_18px_45px_rgba(112,25,61,0.08)] backdrop-blur">
              <Truck className="h-5 w-5 text-[#70193d]" />
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="rounded-[34px] bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.08),transparent_24%),linear-gradient(135deg,#3f0d26,#70193d_55%,#9a4d6c)] p-6 text-white shadow-2xl shadow-[#70193d]/20 sm:col-span-2">
            <p className="text-sm font-semibold uppercase tracking-[0.26em] text-[#f6d7e3]">
